  ...
  def topics
    [
      ...
      PageTopic.new(
        ...
        related_posts: [
          PageTopic.new(
            title: "حملة «شكرا إمارات الخير» تثمن تكفل الإمارات بعلاج 53 جريحا يمنيا في الهند",
            source_name: "إقليم عدن الإخباري",
      ...
      PageTopic.new(
        ...
        related_posts: [
          PageTopic.new(
            title: "قرار جمهوري بتعيين محافظا للبيضاء",
            source_name: "مارب برس",
            created_at: 36.hours.ago
          ),
          PageTopic.new(
            title: "قبيلة مهرية تسيطر على منفذ شحن الحدودي وتطالب بنزول لجنة من التحالف والشرعية",
            source_name: "براقش نت",
            created_at: 12.hours.ago
          )
        ]
      )
