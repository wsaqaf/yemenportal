...
describe NewsParserJob do
  ...
  describe '#perform' do
    it 'create new post' do
      ...
      expect(Post).to receive(:create).with({description: 'description', link: 'link', published_at: item.pubDate, title: 'title',
        source: source, category_id: source.category_id})
